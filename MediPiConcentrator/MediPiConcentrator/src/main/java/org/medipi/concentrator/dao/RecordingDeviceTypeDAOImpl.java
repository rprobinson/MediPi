...
public class RecordingDeviceTypeDAOImpl extends GenericDAOImpl<RecordingDeviceType> implements RecordingDeviceTypeDAO {
    ...
    @Override
    public RecordingDeviceType findBytypeAndSubtype(String type, String subtype) {
        return this.getEntityManager().createNamedQuery("RecordingDeviceType.findByTypeAndSubtype", RecordingDeviceType.class)
