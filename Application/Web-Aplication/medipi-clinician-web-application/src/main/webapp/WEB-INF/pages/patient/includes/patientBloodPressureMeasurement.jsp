...
<script type="text/javascript">
	var includeObject = {patientId : '${param.patientId}', attributeIds : ${param.attributeIds}, canvasId : '${param.canvasId}', accordionTitle : '${param.accordionTitle}', chartHeaders : ${param.chartHeaders}, recentMeasurementDateId : '${param.recentMeasurementDateId}', recentMeasurementValueId : '${param.recentMeasurementValueId}', measurementMinValueId : '${param.measurementMinValueId}', measurementMaxValueId : '${param.measurementMaxValueId}', suggestedMinValue : '${param.suggestedMinValue}', suggestedMaxValue : '${param.suggestedMaxValue}'};
